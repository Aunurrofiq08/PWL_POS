...
class TransaksiPenjualanController extends Controller
{
    public function index(): View
    {
        ...
        $pembelis = PenjualanModel::select(['penjualan_id','pembeli'])->get();

        return view('penjualan.index', ['breadcrumb' => $breadcrumb, 'page' => $page, 'pembelis' => $pembelis,'activeMenu' => $activeMenu]);
    }
    ...
    public function list(Request $request): JsonResponse
    {
         ...
         */
        // if ($request->user_id) {
        //     $penjualans->where('pembeli', $request->user_id);
        // }

        if ($request->penjualan_id) {
            $penjualans->where('pembeli', $request->penjualan_id);
        }
